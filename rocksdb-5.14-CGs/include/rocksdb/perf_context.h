...
struct PerfContext {
  ...
  // HEMANT:
  uint64_t h2saxena_get_at_mem;
  uint64_t h2saxena_get_at_level_0;
  uint64_t h2saxena_get_at_level_1;
  uint64_t h2saxena_get_at_level_2;
  uint64_t h2saxena_get_at_level_3;
  uint64_t h2saxena_get_at_level_4;
  uint64_t h2saxena_get_at_level_5;
  uint64_t h2saxena_get_at_level_6;
  uint64_t h2saxena_get_at_level_7;
  uint64_t h2saxena_merge_for_get;
  uint64_t h2saxena_merge_for_scan;
};
