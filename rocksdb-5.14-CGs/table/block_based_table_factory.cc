...
Status BlockBasedTableFactory::NewTableReader(
	...
	// HEMANT: Set is_column_oriented or not based on level

	/*if(table_reader_options.level >= table_reader_options.ioptions.column_from_k) { // HEMANT
		return BlockBasedTable::Open(
		  table_reader_options.ioptions, table_reader_options.env_options,
		  table_options_, table_reader_options.internal_comparator, std::move(file),
		  file_size, table_reader, table_reader_options.prefix_extractor,
		  prefetch_index_and_filter_in_cache, table_reader_options.skip_filters,
		  table_reader_options.level, true, table_reader_options.cols);
	} else {*/
		return BlockBasedTable::Open(
		  table_reader_options.ioptions, table_reader_options.env_options,
		  table_options_, table_reader_options.internal_comparator, std::move(file),
...
TableBuilder* BlockBasedTableFactory::NewTableBuilder(
	...
	/*if(table_builder_options.level >= table_builder_options.ioptions.column_from_k) { // HEMANT
