...
class Compaction {
 ...
 private:
  ...
  // HEMANT: Column on which this compaction started.
  // This is same as column to which the start level input files belong
  // in the case of compaction from k-1 to k, the output level files (i.e. level k)
  // can belong to multiple levels.
  const int column_;
};
