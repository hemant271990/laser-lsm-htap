...
ImmutableDBOptions::ImmutableDBOptions(const DBOptions& options)
    : create_if_missing(options.create_if_missing),
      column_from_k(options.column_from_k), // HEMANT
      col_attrs_offset(options.col_attrs_offset), // HEMANT
      col_attrs_size(options.col_attrs_size), // HEMANT
...
void ImmutableDBOptions::Dump(Logger* log) const {
  ...
  ROCKS_LOG_HEADER(log, "                      Options.create_if_missing: %d",
                   create_if_missing);
  ROCKS_LOG_HEADER(log, "         Options.column_from_k: %d",
                     column_from_k); // HEMANT
