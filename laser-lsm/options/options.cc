...
AdvancedColumnFamilyOptions::AdvancedColumnFamilyOptions(const Options& options)
    : max_write_buffer_number(options.max_write_buffer_number),
      ...
      column_num(options.column_num), // HEMANT
      delim(options.delim), // HEMANT
      cg_range_matrix(options.cg_range_matrix), // HEMANT
      levels_cg_count(options.levels_cg_count), // HEMANT
