...
DBOptions BuildDBOptions(const ImmutableDBOptions& immutable_db_options,
  ...
  options.column_from_k = immutable_db_options.column_from_k; // HEMANT
  options.col_attrs_offset = immutable_db_options.col_attrs_offset; // HEMANT
  options.col_attrs_size = immutable_db_options.col_attrs_size; // HEMANT
    ...
    OptionsHelper::db_options_type_info = {
        ...
        {"create_if_missing",
         {offsetof(struct DBOptions, create_if_missing), OptionType::kBoolean,
          OptionVerificationType::kNormal, false, 0}},
		{"column_from_k",
		  {offsetof(struct DBOptions, column_from_k), OptionType::kInt,
		    OptionVerificationType::kNormal, false, 0}}, // HEMANT
    ...
    OptionsHelper::cf_options_type_info = {
        ...
        {"compaction_style",
         {offset_of(&ColumnFamilyOptions::compaction_style),
          ...
          0}},
        {"column_num",
		 {offset_of(&ColumnFamilyOptions::column_num),
		  OptionType::kUInt32T, OptionVerificationType::kNormal, false,
		  0}}, // HEMANT
		{"delim",
		 {offset_of(&ColumnFamilyOptions::delim),
		  OptionType::kString, OptionVerificationType::kNormal, false,
		  0}}, // HEMANT
        {"compaction_pri",
