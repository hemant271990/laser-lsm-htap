...
ImmutableCFOptions::ImmutableCFOptions(const ImmutableDBOptions& db_options,
    ...
    : compaction_style(cf_options.compaction_style),
      column_num(cf_options.column_num), // HEMANT
      delim(cf_options.delim), // HEMANT
      column_from_k(db_options.column_from_k), // HEMANT
      col_attrs_offset(db_options.col_attrs_offset), // HEMANT
      col_attrs_size(db_options.col_attrs_size), // HEMANT
      cg_range_matrix(cf_options.cg_range_matrix), // HEMANT
      levels_cg_count(cf_options.levels_cg_count), // HEMANT
