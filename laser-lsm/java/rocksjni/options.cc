 ...
 * Method:    setColumnFromK
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setColumnFromK(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jint flag) {
  reinterpret_cast<rocksdb::Options*>(jhandle)->column_from_k = flag;
}
 ...
 * Signature: (J)Z
 */
jint Java_org_rocksdb_Options_columnFromK(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return reinterpret_cast<rocksdb::Options*>(jhandle)->column_from_k;
}
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setDelim(JNIEnv* env,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jstring flag) {
  const char* delim = env->GetStringUTFChars(flag, nullptr);
    if (delim == nullptr) {
      // exception thrown: OutOfMemoryError
      return;
    }
    reinterpret_cast<rocksdb::Options*>(jhandle)->delim.assign(delim);
    env->ReleaseStringUTFChars(flag, delim);
}
 ...
 * Signature: (J)Z
 */
jstring Java_org_rocksdb_Options_delim(JNIEnv* env,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return env->NewStringUTF(
        reinterpret_cast<rocksdb::Options*>(jhandle)->delim.c_str());
}
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_Options_setColumnNum(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jint flag) {
  reinterpret_cast<rocksdb::Options*>(jhandle)->column_num = flag;
}
 ...
 * Signature: (J)Z
 */
jint Java_org_rocksdb_Options_columnNum(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return reinterpret_cast<rocksdb::Options*>(jhandle)->column_num;
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setColAttrsOffset
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_Options_setColAttrsOffset(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jintArray joffsets) {
  std::vector<size_t> offsets;

  const jsize len = env->GetArrayLength(joffsets);
  for (jsize i = 0; i < len; i++) {
	jint* joffsets_ptr = env->GetIntArrayElements(joffsets, nullptr);
	if (joffsets_ptr == nullptr) {
		// exception thrown: OutOfMemoryError
		return;
	}
	uint32_t offset = static_cast<uint32_t>(joffsets_ptr[i]);
	offsets.push_back(offset);
  }

  auto* opt = reinterpret_cast<rocksdb::Options*>(jhandle);
  opt->col_attrs_offset = offsets;
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setColAttrsSize
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_Options_setColAttrsSize(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jintArray joffsets) {
  std::vector<size_t> offsets;
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setDelim(JNIEnv* env,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jstring flag) {
  const char* delim = env->GetStringUTFChars(flag, nullptr);
  ...
  reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->delim.assign(delim);
  env->ReleaseStringUTFChars(flag, delim);
}
 ...
 * Signature: (J)Z
 */
jstring Java_org_rocksdb_ColumnFamilyOptions_delim(JNIEnv* env,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return env->NewStringUTF(
          reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->delim.c_str());
}
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setColumnNum(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jint flag) {
  reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->column_num = flag;
}
 ...
 * Signature: (J)Z
 */
jint Java_org_rocksdb_ColumnFamilyOptions_columnNum(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->column_num;
}
// HEMANT end
 ...
 * Signature: (JZ)V
 */
void Java_org_rocksdb_DBOptions_setColumnFromK(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jint flag) {
  reinterpret_cast<rocksdb::DBOptions*>(jhandle)->column_from_k = flag;
}
 ...
 * Signature: (J)Z
 */
jint Java_org_rocksdb_DBOptions_columnFromK(JNIEnv* /*env*/,
                                                    jobject /*jobj*/,
                                                    jlong jhandle) {
  return reinterpret_cast<rocksdb::DBOptions*>(jhandle)->column_from_k;
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_DBOptions_setColAttrsOffset(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jintArray joffsets) {
  std::vector<size_t> offsets;
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_DBOptions_setColAttrsSize(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jintArray joffsets) {
  std::vector<size_t> offsets;
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ReadOptions_setFilterColumns(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jintArray jcolumns) {
  std::vector<uint32_t> columns;

  const jsize len = env->GetArrayLength(jcolumns);
  for (jsize i = 0; i < len; i++) {
	jint* jcolumns_ptr = env->GetIntArrayElements(jcolumns, nullptr);
	if (jcolumns_ptr == nullptr) {
		// exception thrown: OutOfMemoryError
		return;
	}
	uint32_t column = static_cast<uint32_t>(jcolumns_ptr[i]);
	columns.push_back(column);
  }

  auto* opt = reinterpret_cast<rocksdb::ReadOptions*>(jhandle);
  opt->filter_columns = columns;
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ReadOptions_setFilterTypes(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jcharArray jtypes) {
  std::vector<char> types;

  const jsize len = env->GetArrayLength(jtypes);
  for (jsize i = 0; i < len; i++) {
	jchar* jtypes_ptr = env->GetCharArrayElements(jtypes, nullptr);
	if (jtypes_ptr == nullptr) {
		// exception thrown: OutOfMemoryError
		return;
	}
	char type = static_cast<char>(jtypes_ptr[i]);
	types.push_back(type);
  }

  auto* opt = reinterpret_cast<rocksdb::ReadOptions*>(jhandle);
  opt->filter_types = types;
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ReadOptions_setFilterValues(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jobjectArray jvalues) {
	std::vector<std::string> values;
	const jsize len = env->GetArrayLength(jvalues);
	jboolean has_exception = JNI_FALSE;
	for (jsize i = 0; i < len; i++) {
		jobject jfvalue =	reinterpret_cast<jstring>(env->GetObjectArrayElement(jvalues, i));
		if (env->ExceptionCheck()) {
		  return;
		}
		std::string value = rocksdb::JniUtil::copyStdString(env, static_cast<jstring>(jfvalue), &has_exception);
		env->DeleteLocalRef(jfvalue);

		values.push_back(value);
	}

	auto* opt = reinterpret_cast<rocksdb::ReadOptions*>(jhandle);
	opt->filter_values = values;
}

/*
 * Class:     org_rocksdb_Options
 * Method:    setFilterComparator
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ReadOptions_setFilterComparator(JNIEnv* env, jobject /*jobj*/,
                                         jlong jhandle, jobjectArray jvalues) {
	std::vector<std::string> values;
	const jsize len = env->GetArrayLength(jvalues);
	jboolean has_exception = JNI_FALSE;
