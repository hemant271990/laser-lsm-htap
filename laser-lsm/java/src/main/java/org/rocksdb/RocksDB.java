...
public class RocksDB extends RocksObject {
  ...
  static {
    ...
    libs.add("/home/h2saxena/klsm-master/klsm/rocksdb-5.14-hemant/java/target");
    RocksDB.loadLibrary(libs);
  }
   ...
   * RangeQuery()
   */
  public int rangeQuery(final ReadOptions opt, final String begin, final String end)
        throws RocksDBException {
      return rangeQuery(nativeHandle_, opt.nativeHandle_, begin, end);
  }
  // HEMANT end
  ...
  protected native int rangeQuery(long handle, long readOptHandle, String begin, String end) throws RocksDBException; // HEMANT
