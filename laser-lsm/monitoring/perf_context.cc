...
void PerfContext::Reset() {
  ...
  // HEMANT:
  h2saxena_get_at_mem = 0;
  h2saxena_get_at_level_0 = 0;
  h2saxena_get_at_level_1 = 0;
  h2saxena_get_at_level_2 = 0;
  h2saxena_get_at_level_3 = 0;
  h2saxena_get_at_level_4 = 0;
  h2saxena_get_at_level_5 = 0;
  h2saxena_get_at_level_6 = 0;
  h2saxena_get_at_level_7 = 0;
  h2saxena_merge_for_get = 0;
  h2saxena_merge_for_scan = 0;
#endif
}
...
std::string PerfContext::ToString(bool exclude_zero_counters) const {
  ...
  // HEMANT
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_mem);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_0);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_1);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_2);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_3);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_4);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_5);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_6);
  PERF_CONTEXT_OUTPUT(h2saxena_get_at_level_7);
  PERF_CONTEXT_OUTPUT(h2saxena_merge_for_get);
  PERF_CONTEXT_OUTPUT(h2saxena_merge_for_scan);
  return ss.str();
#endif
}
